...
All of it. Your plans and workouts, every set you log, your training history, bodyweight and
readiness check-ins, your name, goal, height and weight from the setup questions, any exercises and
photos you create yourself, your badges, and the coach's notes and reports.

This is stored in a private database inside the app's own container on your iPhone. Other apps
cannot read it. We cannot read it. It is included in your device backup if you back up your iPhone,
which is between you and Apple.
...
Apple's handling of your purchase is covered by Apple's privacy policy and the Apple Media Services
...
- **Profile → Reset all data** clears your plans, history and progress.
- **Deleting the app** removes everything, including the database itself.
