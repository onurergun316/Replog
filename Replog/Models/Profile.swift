...
final class AppSettings {
    ...
    /// Which `TemplateBackfill` version has run — repairing plans whose sets were logged
    /// before finishing a workout started writing its numbers back. Versioned rather than
